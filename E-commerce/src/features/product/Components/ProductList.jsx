...
export default function ProductList() {
  ...
  const status = useSelector(selectedProducListStatus);
  ...
  useEffect(() => {
    ...
    dispatch(fetchProducFiltersAsync({ filter, sort,pagination }))
            ...
            {products.map((product) => (
              ...
              <Link to={`/product-details/${product.id}`}>
                ...
                >
                  ...
                  {product.stock<=0 && (<div>
                    <p className="text-sm text-red-400">Out of Stock Deleted</p>
