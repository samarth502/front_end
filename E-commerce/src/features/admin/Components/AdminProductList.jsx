...
import {
  ...
  fetchProducFiltersAsync,
  // fetchProducFiltersfilterAsync,
  selectAllBrands,
  selectAllCategories,
  selectAllProducts,
  selectTotalItems,
...
export default function AdminProductList() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchProducFiltersAsync({ filter, sort,pagination,admin:true }))
        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              className="rounded-md mx-10 my-4 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Add Product
            </Link>
            </div>
